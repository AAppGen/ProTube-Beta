...
public class ApplovinInterstitialAdDownload implements MaxAdListener {

    private static ApplovinInterstitialAdDownload mInstance;
    ...
    public static ApplovinInterstitialAdDownload getInstance() {
        if (mInstance == null) {
            mInstance = new ApplovinInterstitialAdDownload();
        }
        return mInstance;
    }
    ...
    public void showInterstitialAd(Activity activity, AdClosedListener mAdClosedListener) {
        if (AdUtils.isReadyToShowInterstitialAdDownload(activity) && interstitialAd != null && interstitialAd.isReady()) {
        ...
        AdUtils.updateCounterForNextInterstitialAdDownload(activity);
    }
}