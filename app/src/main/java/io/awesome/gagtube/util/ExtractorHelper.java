...
public final class ExtractorHelper {
	...
	public static Single<CommentsInfo> getCommentsInfo(final int serviceId, final String url, final boolean forceLoad) {
		return Single.fromCallable(() -> CommentsInfo.getInfo(NewPipe.getService(serviceId), url));
	}

	public static Single<InfoItemsPage> getMoreCommentItems(final int serviceId, final CommentsInfo info, final Page nextPage) {
