...
import static io.awesome.gagtube.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_POPUP;
...
public class PlayerHelper {
     ...
     * <br><br>
     * To select the next video, {@link StreamInfo#getRelatedItems()} is checked first.
     * If it is non-null and is not part of the existing items, it will be used as the next video.
     * Otherwise, an random item with non-repeating url will be selected from the {@link StreamInfo#getRelatedItems()}.
     */
    @Nullable
